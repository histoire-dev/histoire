...
<template>
  ...
  >
    <div
      class="htw:border htw:border-solid group-active:htw:bg-gray-500/20 htw:rounded-sm htw:box-border htw:absolute htw:inset-0 htw:transition-border htw:duration-150 htw:ease-out group-hover:htw:border-primary-500 group-hover:htw:dark:border-primary-500"
      :class="[
        modelValue
          ? 'htw:border-primary-500 htw:border-8'
          : 'htw:border-black/25 htw:dark:border-white/25 htw:delay-150',
      ]"
    />
    <svg
      width="16"
