  ...
  >
    <div class="htw:flex htw:flex-row htw:gap-1">
      <input
        ...
        v-model="stringModel"
        type="text"
        class="htw:text-inherit htw:bg-transparent htw:w-full htw:outline-none htw:px-2 htw:py-1 -htw:my-1 htw:border htw:border-solid htw:border-black/25 htw:dark:border-white/25 focus:htw:border-primary-500 dark:focus:htw:border-primary-500 htw:rounded-sm"
      >
      <input
        type="color"
        :value="modelValue"
