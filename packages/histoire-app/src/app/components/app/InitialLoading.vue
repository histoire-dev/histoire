...
<template>
  <div class="histoire-initial-loading htw:fixed htw:inset-0 htw:bg-white htw:dark:bg-gray-700 htw:flex htw:flex-col htw:gap-6 htw:items-center htw:justify-center">
