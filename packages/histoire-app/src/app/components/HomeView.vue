...
<template>
  <div class="histoire-home-view htw:flex md:htw:flex-col htw:gap-12 htw:items-center htw:justify-center htw:h-full">
    ...
    >
    <div class="htw:flex !md:htw:flex-col htw:flex-wrap htw:justify-evenly htw:gap-2 htw:px-4 htw:py-2 htw:bg-gray-100 htw:dark:bg-gray-750 htw:rounded htw:border htw:border-gray-500/30">
      <HomeCounter
        title="Stories"
        icon="carbon:cube"
